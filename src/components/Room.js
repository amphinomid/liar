...
const outdoors = ['archery', 'badminton', 'baseball', 'basketball', 'beach volleyball', 'beekeeping', 'birdwatching', 'bodyboarding', 'camping', 'canoeing', 'capture the flag', 'cricket', 'cross-country skiing', 'cycling', 'diving', 'dodgeball', 'dragon boat racing', 'fishing', 'football', 'free play', 'frisbee', 'gardening', 'hacky sack', 'hide and seek', 'hiking', 'hopscotch', 'horseback riding', 'ice skating', 'inline skating', 'kayaking', 'keep away (ball)', 'kite flying', 'landscape painting', 'lawn bowling', 'mountaineering', 'outrigger canoeing', 'photography', 'picnics', 'rock climbing', 'rowing', 'running', 'sailing', 'sightseeing', 'skateboarding', 'skiing', 'skipping rope', 'snorkelling', 'snowboarding', 'soccer', 'sunbathing', 'surfing', 'swimming', 'tag', 'tennis', 'tobogganing', 'trampolining', 'tug of war', 'walking', 'water fight', 'windsurfing']
