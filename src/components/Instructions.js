    ...
    return (
        <div>
            ...
            <p style={{ width: '75vw', fontSize: '1.5rem', textAlign: 'justify', margin: 'auto' }}>
                ...
                the specific rules are up to you and your friends (e.g. # of rounds), but typically, players take turns describing the word; the non-liars try to prove their innocence
                without revealing enough for the liar to guess the word, while the liar tries to fit in. at the end, everyone votes on who they think the liar is.
            </p>
